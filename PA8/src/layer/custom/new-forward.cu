...
__global__ void fc_forward_kernel(float* device_y, const float* device_x, const float* device_w, const float* device_b, const int NUM, const int DIM_in, const int DIM_out)
{
    // Extra credit
    /* 
    ...
    HINT: the functionality of the linear layer is equivalent to the forward pass implemented in ./src/layer/fully_connected.cc
    */
    
}

__host__ void GPUInterface::fc_forward_gpu_prolog(const float *host_y, const float *host_x, const float *host_w, const float *host_b, float **device_y_ptr, float **device_x_ptr, float **device_w_ptr, float **device_b_ptr, const int NUM, const int DIM_in, const int DIM_out)
{
    // Extra credit
    // Allocate memory and copy over the relevant data structures to the GPU
...
__host__ void GPUInterface::fc_forward_gpu(float *device_y, const float *device_x, const float *device_w, float *device_b, const int NUM, const int DIM_in, const int DIM_out)
{
    // Extra credit
    // Set the kernel dimensions and call the kernel
...
__host__ void GPUInterface::fc_forward_gpu_epilog(float *host_y, float *device_y, float *device_x, float *device_w, float *device_b, const int NUM, const int DIM_in, const int DIM_out)
{
    // Extra credit
    // Copy the output back to host
